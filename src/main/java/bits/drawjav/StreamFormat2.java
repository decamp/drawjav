...
//
//
//    public static StreamFormat2 create( int w, int h, int format, Rational aspect ) {
...
//
//
//    public static StreamFormat2 create( JavFrame packet ) {
//        return new StreamFormat2( AVMEDIA_TYPE_AUDIO,
//                                  NO_CHANNELS,
//                                  NO_SAMPLE_RATE,
//                                  AV_SAMPLE_FMT_NONE,
...
//        case AVMEDIA_TYPE_VIDEO:
//            return create( cc.pixelFormat(), cc.width(), cc.height(), cc.sampleAspectRatio() );
//        }
//

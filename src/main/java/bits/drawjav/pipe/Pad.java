...
/**
 * A Pad is like a slot or a port on a unit that either receives input packets or delivers output packets.
 * There are two main types: InPads and OutPads, which represent unit inputs and unit outputs respectively.
 * <p>
 ...
 * <li>Only report overflow when the OutPads on the owning unit must be drained.
 * </ul>
 *
 * Threaded pads:
 * <ul>
 ...
 * <li>May have multiple reasons for overflowing:  1) the OutPads of owning unit must be drained, 2) the
...
public interface Pad {
    ...
    public static final int FILL_UNIT  = 2;
    public static final int DRAIN_UNIT = 3;
    public static final int WAIT       = 4;

    /**
     * Must be called before opening unit.

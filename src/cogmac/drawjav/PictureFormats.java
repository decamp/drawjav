...
public final class PictureFormats {
    ...
    public static boolean isCompatible( PictureFormat source, PictureFormat dest ) {
        ...
        if( source.pixelFormat() != JavConstants.PIX_FMT_NONE && 
            dest.pixelFormat() != JavConstants.PIX_FMT_NONE && 
    ...
    public static boolean isFullyDefined( PictureFormat format ) {
        ...
        return format.width() >= 0 && 
               format.height() >= 0 && 
               format.pixelFormat() != JavConstants.PIX_FMT_NONE;
    }
                                       ...
                                       PictureFormat req ) 
    {
        ...
        if( fmt == null ) {
            if( req == null ) {
                return new PictureFormat( -1, -1, JavConstants.PIX_FMT_NONE );
            }
        ...
        if( outFmt == JavConstants.PIX_FMT_NONE ) {
            outFmt = inFmt;
        }
